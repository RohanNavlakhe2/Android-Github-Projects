...
public class CheckoutActivityJava extends AppCompatActivity {
    ...
    private void pay() {
        ...
        //Test
        // (creating params with our own values (Taken from our own views)
        //And pass those values (Cardnumber,exp date etc) to Builder's constructor
        Card.Builder builder = new Card.Builder();
        PaymentMethodCreateParams.Card card = builder.build().toPaymentMethodParamsCard();
